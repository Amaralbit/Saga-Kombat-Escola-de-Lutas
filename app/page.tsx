  ...
  return (
    <main>
      ...
      <section className="section location" id="localizacao">
        ...
        <div className="map-wrap" data-reveal style={{ '--d': 1 } as React.CSSProperties}><iframe title="Mapa da Saga Kombat Escola de Lutas" src="https://www.google.com/maps?q=-16.7363462,-49.2726967&z=16&output=embed" loading="lazy" referrerPolicy="no-referrer-when-downgrade" /><div className="map-corner">SAGA<br /><b>KOMBAT</b></div></div>
      </section>
